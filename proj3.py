...
def diff(x, h, func):  # вычисление производной методом центральной конечной разности
    return (func(x + h) - func(x - h)) / (2 * h)

def runge(epsilon, func, h, x):  # вычисление производной с оценкой погрешности правилом рунге
    h1 = h
