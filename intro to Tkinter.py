...
j = float(0)
while j < 100:
    canvas.create_oval(100+j,600 - 100*f(j/100),100+j+1,599-100*f(j/100),outline='red')
    canvas.create_line(100+j,602,100+j,598)
    canvas.create_line(98,600 - 100*f(j/100),102,600 - 100*f(j/100))
    j+=1
canvas.create_text(75,600,text='O',font='helvetica 14')
canvas.create_text(725,620,text='x',font='helvetica 14')
canvas.create_text(75,100,text='y',font='helvetica 14')
canvas.create_text(75,500,text='1',font='helvetica 14')
canvas.create_text(200,450,text='f(x) = exp(x)',font='helvetica 14')
canvas.create_text(200,610,text='1',font='helvetica 14')
